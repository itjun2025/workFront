...
/*
    ...
    * 주의 
        예약어를 붙이지 않은 경우
        오류가 발생하지 않으며 전역 변수로생성됨
*/ 

// 전역변수(gloval variable) : 함수 외부에서 변수를 선언
g_str1 = '전역변수';
var g_str2 = 'var 전역변수';
let g_str3 = 'let 전역변수';
...
// 전역변수 사용시 'window.변수명' ghrdms 'this.변수명'으로 접근가능

// var로 선언하면 window객체에서 연결
...
function test(){
   ...
   /*
        ...
        변수선언무과 함수선언문 유효범위 최상단에 선언(변수는 undefined로 초기화)
   */
    console.log(g_str2);
...
window.onload = function(){
    ...
    // let 으로 선언시 num1을 선언문이 나오기 전에 사용불가
